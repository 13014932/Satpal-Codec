...
<input type="submit" id="submit" value="submit" name="s_submit">
</form>
...
include 'db_control_simple.php';
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		//$data=array();
		//do {
		//$data[]='(".$red_clay.$i."','".$yamuna.$i."','".$reti.$i."','".$rori.$i."','".$qunatity.$i."')';
		 $sql_spice = "INSERT INTO curd_simple (firstname, lastname, email, mobile, qunatity) 

		VALUES ('".$red_clay.$i."','".$yamuna.$i."','".$reti.$i."','".$rori.$i."','".$qunatity.$i."')";
